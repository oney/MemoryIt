...
//        CGFloat zoom = 0.5*(1+self.transitionProgress);
//        currentAttribute.transform3D = CATransform3DMakeScale(zoom, zoom, 1.0);
//        currentAttribute.transform = CGAffineTransformMakeScale(0.5*(1+self.offset.vertical), 0.5*(1+self.offset.vertical));
